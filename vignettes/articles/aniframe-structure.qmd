...
[Orientation](orientation.html) covers the conventions, how orientation
follows the frame's axes, and why it is not the direction of travel.

## Where to next?

- [The metadata attribute](aniframe-metadata.html) — units, sampling
  rate, and the setters that keep them consistent with the data.
- [Orientation](orientation.html) — which way the axes point, and which
  way an entity faces.
